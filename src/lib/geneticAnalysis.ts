...
const DISEASE_RISK_GENES: Record<string, Record<string, { riskAlleles: string[]; weight: number }>> = {
  ...
  Parkinson: {
    LRRK2: { riskAlleles: ['G'], weight: 2.5 },
    SNCA: { riskAlleles: ['A'], weight: 2.0 },
    PARK7: { riskAlleles: ['T'], weight: 1.8 },
    PINK1: { riskAlleles: ['C'], weight: 1.7 },
    GBA: { riskAlleles: ['A'], weight: 2.2 },
    MAPT: { riskAlleles: ['T'], weight: 1.3 },
    VPS35: { riskAlleles: ['G'], weight: 1.1 },
    COMT: { riskAlleles: ['A'], weight: 1.0 },
  },
  Asthma: {
    ORMDL3: { riskAlleles: ['T'], weight: 1.6 },
    IL33: { riskAlleles: ['A'], weight: 1.4 },
    IL1RL1: { riskAlleles: ['G'], weight: 1.3 },
    TSLP: { riskAlleles: ['C'], weight: 1.2 },
    IL13: { riskAlleles: ['A'], weight: 1.5 },
    HLA_DQ: { riskAlleles: ['T'], weight: 1.1 },
    ADAM33: { riskAlleles: ['G'], weight: 1.3 },
    ADRB2: { riskAlleles: ['A'], weight: 1.0 },
  },
  Obesity: {
    FTO: { riskAlleles: ['A'], weight: 1.8 },
    MC4R: { riskAlleles: ['T'], weight: 1.6 },
    TMEM18: { riskAlleles: ['G'], weight: 1.2 },
    GNPDA2: { riskAlleles: ['A'], weight: 1.0 },
    BDNF: { riskAlleles: ['T'], weight: 1.4 },
    SH2B1: { riskAlleles: ['C'], weight: 1.1 },
    NEGR1: { riskAlleles: ['A'], weight: 1.3 },
    PCSK1: { riskAlleles: ['G'], weight: 1.5 },
  },
  Hypertension: {
    AGT: { riskAlleles: ['T'], weight: 1.5 },
    ACE: { riskAlleles: ['D'], weight: 1.4 },
    ADD1: { riskAlleles: ['T'], weight: 1.2 },
    CYP11B2: { riskAlleles: ['C'], weight: 1.3 },
    NOS3: { riskAlleles: ['A'], weight: 1.1 },
    ADRB1: { riskAlleles: ['G'], weight: 1.0 },
    NPPA: { riskAlleles: ['T'], weight: 1.3 },
    GNB3: { riskAlleles: ['T'], weight: 1.2 },
  },
  'Cystic Fibrosis': {
    CFTR: { riskAlleles: ['T'], weight: 3.0 },
    SCNN1A: { riskAlleles: ['A'], weight: 1.2 },
    TGFB1: { riskAlleles: ['C'], weight: 1.0 },
    MBL2: { riskAlleles: ['G'], weight: 0.9 },
    SERPINA1: { riskAlleles: ['T'], weight: 1.1 },
    DCTN4: { riskAlleles: ['A'], weight: 1.0 },
    SLC26A9: { riskAlleles: ['G'], weight: 1.3 },
    EHF: { riskAlleles: ['T'], weight: 0.8 },
  },
  'Sickle Cell Disease': {
    HBB: { riskAlleles: ['T'], weight: 3.0 },
    BCL11A: { riskAlleles: ['A'], weight: 1.5 },
    HBS1L: { riskAlleles: ['G'], weight: 1.2 },
    MYB: { riskAlleles: ['C'], weight: 1.0 },
    HBA1: { riskAlleles: ['T'], weight: 1.8 },
    HBA2: { riskAlleles: ['A'], weight: 1.6 },
    KLF1: { riskAlleles: ['G'], weight: 1.1 },
    NOS1: { riskAlleles: ['T'], weight: 0.9 },
  },
  Epilepsy: {
    SCN1A: { riskAlleles: ['A'], weight: 2.2 },
    SCN2A: { riskAlleles: ['T'], weight: 1.8 },
    KCNQ2: { riskAlleles: ['G'], weight: 1.5 },
    GABRA1: { riskAlleles: ['C'], weight: 1.3 },
    CHRNA4: { riskAlleles: ['T'], weight: 1.2 },
    SLC2A1: { riskAlleles: ['A'], weight: 1.4 },
    DEPDC5: { riskAlleles: ['G'], weight: 1.6 },
    TSC1: { riskAlleles: ['T'], weight: 1.7 },
  },
  'Celiac Disease': {
    HLA_DQ2: { riskAlleles: ['T'], weight: 2.5 },
    HLA_DQ8: { riskAlleles: ['A'], weight: 2.0 },
    IL2: { riskAlleles: ['G'], weight: 1.0 },
    IL21: { riskAlleles: ['C'], weight: 1.1 },
    MYO9B: { riskAlleles: ['T'], weight: 1.2 },
    CTLA4: { riskAlleles: ['A'], weight: 1.3 },
    SH2B3: { riskAlleles: ['G'], weight: 1.0 },
    CCR3: { riskAlleles: ['T'], weight: 0.9 },
  },
};
